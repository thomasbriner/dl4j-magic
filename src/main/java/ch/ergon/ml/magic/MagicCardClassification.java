...
public class MagicCardClassification {
	protected static final Logger log = LoggerFactory.getLogger(MagicCardClassification.class);
...
//		MultiLayerNetwork network =  alexnetModel();
	...
	public static void main(String[] args) throws Exception {
		new MagicCardClassification().run(args);
	}
